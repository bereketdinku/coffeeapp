  ...
  const PaymentMethod: React.FC<PaymentMethodProps> = ({
    ...
    return (
        <View style={[
            ...
            {isIcon?(
                <LinearGradient start={{x:0,y:0}} end={{x:1,y:1}} colors={[COLORS.primaryGreyHex,COLORS.primaryBlackHex]} style={styles.LinearGradientWallet}>
...
<Text style={styles.PaymentPrice}>${100.50}</Text>
            ...
            ):(<LinearGradient start={{x:0,y:0}} end={{x:1,y:1}} colors={[COLORS.primaryGreyHex,COLORS.primaryBlackHex]} style={styles.LinearGradientRegular}>
