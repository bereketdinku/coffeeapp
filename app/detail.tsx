...
const Detail=()=>{
    const{id,index,type}=useLocalSearchParams<{index:string,id:string,type:string}>()
   const ItemOfIndex=useStore((state:any)=>type=='Coffee'?state.CoffeeList:state.BeanList)[index];
...
{ItemOfIndex.prices.map((data:any)=>(
   <TouchableOpacity key={data.size} onPress={()=>{
      ...
      styles.SizeBox,{borderColor:data.size==price.size?COLORS.primaryOrangeHex:COLORS.primaryDarkGreyHex}
   ]}>
<Text style={[
   styles.SizeText,
   {
